<?php
namespace Crud\Custom\NovumJenv\Persoon\Base;
...
abstract class CrudPersoonManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumJenv\Map\PersoonTableMap();
	}
	...
	{
		return "/custom/novumjenv/persoonsgegevens/persoon/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumjenv/persoonsgegevens/persoon/edit";
	}
