...
class PersoonTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Custom.NovumJenv.Map.PersoonTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Custom\\NovumJenv\\Persoon';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Custom.NovumJenv.Persoon';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Bsn', ),
        self::TYPE_CAMELNAME     => array('id', 'bsn', ),
        self::TYPE_COLNAME       => array(PersoonTableMap::COL_ID, PersoonTableMap::COL_BSN, ),
        self::TYPE_FIELDNAME     => array('id', 'bsn', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Bsn' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'bsn' => 1, ),
        self::TYPE_COLNAME       => array(PersoonTableMap::COL_ID => 0, PersoonTableMap::COL_BSN => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'bsn' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Custom\\NovumJenv\\Persoon');
    ...
    {
        $this->addRelation('Hechtenis', '\\Model\\Custom\\NovumJenv\\Hechtenis', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Hechteniss', false);
        $this->addRelation('VoorlopigeHechtenis', '\\Model\\Custom\\NovumJenv\\VoorlopigeHechtenis', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'VoorlopigeHechteniss', false);
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Custom\NovumJenv\Persoon) { // it's a model object
